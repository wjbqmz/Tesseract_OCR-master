...
public class exportExcelUtil {
	...
	public static void exportExcel(String output, WritableSheet ws,String filename)
			throws Exception {
		// 截取一次结果后的公司名称和编号
		int size = 100;
		...
		ws.addCell(new Label(2, row + 1, filename));
		row++;
